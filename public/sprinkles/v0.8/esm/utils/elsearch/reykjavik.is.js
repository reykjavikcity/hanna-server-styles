...
const defaultQuery = (value, props) => {
  let finalQuery = null;
  let fields = [];
  if (value && value !== "") {
...
const searchResultsPageQuery = (query) => {
  const {
    value,
...
const postQuery = (url, queries, signal) => {
