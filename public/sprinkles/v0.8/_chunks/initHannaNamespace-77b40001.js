System.register(["./qj-0ce4c6bc.js", "./i18n-5b23de04.js", "./getLang-61538edc.js"], function(exports, module) {
  "use strict";
  var getScrollbarWidth, qq, setDefaultLanguage, getLang;
  return {
    setters: [(module2) => {
      getScrollbarWidth = module2.h;
      qq = module2.a;
    }, (module2) => {
      setDefaultLanguage = module2.s;
    }, (module2) => {
      getLang = module2.g;
    }],
    execute: function() {
      ...
      if (lacksIntersectionObserverSuppport) {
        module.import("./qj-0ce4c6bc.js").then((n) => n.I);
      }
