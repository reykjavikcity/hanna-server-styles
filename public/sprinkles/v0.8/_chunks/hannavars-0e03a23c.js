System.register(["./getSVGtext-2c45db0c.js", "./ObjectHelpers-a9c65074.js", "./i18n-5b23de04.js", "./assets-7c5ecab5.js"], function(exports, module) {
  "use strict";
  var ObjectKeys, styleServerUrl;
  return {
    setters: [null, (module2) => {
      ObjectKeys = module2.O;
    }, null, (module2) => {
...
Disallowed name: ${name}`);
      ...
      const getCssBundleUrl = exports("g", /* @__NO_SIDE_EFFECTS__ */ (cssTokens, options) => {
        options = options || {};
