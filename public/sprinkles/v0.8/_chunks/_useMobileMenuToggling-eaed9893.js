System.register(["./compat.module-fe631ce3.js", "./getSVGtext-2c45db0c.js", "./i18n-5b23de04.js", "./qj-0ce4c6bc.js"], function(exports, module) {
  "use strict";
  var Cn, compat_module, F, getAugmentedNamespace, commonjsGlobal;
  return {
    setters: [(module2) => {
      Cn = module2.C;
      compat_module = module2.c;
      F = module2.b;
    }, null, null, (module2) => {
      getAugmentedNamespace = module2.i;
      commonjsGlobal = module2.j;
    }],
    execute: function() {
      var formatchange = {};
      ...
      let _formatMonitor;
      const getFormatMonitor = exports("g", /* @__NO_SIDE_EFFECTS__ */ () => {
        if (!_formatMonitor) {
      ...
      let domid_incr = 0;
      const domid = exports("d", () => domid_prefix + domid_incr++);
      const useDomid = exports("u", useId ? (staticId) => {
        const id = useId();
        return staticId || id;
      } : (staticId) => {
      ...
      var react = {};
      const require$$0 = exports("r", /* @__PURE__ */ getAugmentedNamespace(compat_module));
