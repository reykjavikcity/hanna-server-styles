System.register(["./compat.module-919773fc.js"], function(exports, module) {
  ...
  return {
    ...
    execute: function() {
      ...
      let observer;
      const getObserver = exports("g", (target, callback) => {
      ...
      const hasLegacySeenEffectsCSS = exports("h", !!document.querySelector('link[rel="stylesheet"][href*="/bundle/"][href*="-legacy-AutoSeenEffects"]'));
      const autoSeenEffectsRefresh = exports("b", hasLegacySeenEffectsCSS ? () => {
      ...
      const autoSeenEffectWrapperProps = exports("a", hasLegacySeenEffectsCSS ? (elm) => {
        const {
          isSeen,
          seenEffect
        } = elm.dataset;
      ...
      const autoSeenEffectPrepare = exports("c", hasLegacySeenEffectsCSS ? (elm) => {
