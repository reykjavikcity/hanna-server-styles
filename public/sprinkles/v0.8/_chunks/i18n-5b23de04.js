System.register([], function(exports, module) {
  ...
  return {
    execute: function() {
      ...
      let DEFAULT_LANG = exports("D", _BASE_DEFAULT_LANG);
      const _history = [];
      const setDefaultLanguage = exports("s", (newLang) => {
        if (newLang === DEFAULT_LANG) {
          return;
        }
        exports("D", DEFAULT_LANG = !newLang ? _BASE_DEFAULT_LANG : langs.has(newLang) ? newLang : _BASE_FALLBACK_LANG);
      ...
      setDefaultLanguage.pop = () => {
        _history.shift();
        exports("D", DEFAULT_LANG = _history[0] || _BASE_DEFAULT_LANG);
      };
      const langMissing = /* @__NO_SIDE_EFFECTS__ */ (lang, defaultTexts) => {
        return defaultTexts;
      };
      const getTexts = exports("g", /* @__NO_SIDE_EFFECTS__ */ (props, defaultTexts) => {
