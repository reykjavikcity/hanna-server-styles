System.register(["./compat.module-fe631ce3.js"], function(exports, module) {
  ...
  return {
    ...
    execute: function() {
      exports("o", o);
      const classes = exports("c", /* @__NO_SIDE_EFFECTS__ */ (...classNames) => {
        let classStr = "";
      ...
      const modifiedClass = exports("m", /* @__NO_SIDE_EFFECTS__ */ (bemClass, modifiers, extraClass) => {
      ...
      const useIsBrowserSide = exports("u", (ssrSupport) => useClientState(false, true, ssrSupport)[0] || void 0);
      var _ = 0;
